...
const RefundAndCancellation = () => {
  return (
    <div className="refund-and-cancellation">
      ...
      <p>Last updated on 06-02-2025 07:21:31</p>
      <p>NAVEEN CHANDRA GAUR believes in helping its customers as far as possible, and has therefore a liberal cancellation policy. Under this policy:</p>
      <ul>
        ...
        <li>NAVEEN CHANDRA GAUR does not accept cancellation requests for perishable items like flowers, eatables etc. However, refund/replacement can be made if the customer establishes that the quality of product delivered is not good.</li>
        ...
        <li>In case of complaints regarding products that come with a warranty from manufacturers, please refer the issue to them. In case of any Refunds approved by the NAVEEN CHANDRA GAUR, it’ll take 1-2 Days days for the refund to be processed to the end customer.</li>
      </ul>
    </div>
  );
};

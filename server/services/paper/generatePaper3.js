...
import { formatQuestionPaper3, getAnswerpaper3 } from '../../utils/docx/formatQuestionPaper3.js';
...
export const generatePaper3 = async (data) => {

console.log("req in generatePaper3",data);
